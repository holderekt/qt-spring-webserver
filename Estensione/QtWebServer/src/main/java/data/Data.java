...
public class Data {
    ...
    /**
     * Restiuisce i valori contenuti in una colonna in posizione column_index
     *
     * @param column_index Posizione della colonna
     * @return list
     */
    public List<Object> getColumns(int column_index){
        List<Object> list = new ArrayList<>();
        for(int i =0; i!= getNumberOfExplanatoryAttributes(); i++){
            list.add(getValue(i, column_index));
        }
